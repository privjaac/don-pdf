...
public class TextElement implements Element {
    ...
    private void applyFragmentProperties(Text textElement, TextProperty properties, PdfFont defaultFont, Float defaultFontSize) {
        ...
        if (ofNullable(properties.getIsBold()).orElse(false)) textElement.setProperty(Property.BOLD_SIMULATION, true);
        if (ofNullable(properties.getIsItalic()).orElse(false)) textElement.setProperty(Property.ITALIC_SIMULATION, true);
