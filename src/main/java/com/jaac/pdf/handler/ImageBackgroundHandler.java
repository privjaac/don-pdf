...
public class ImageBackgroundHandler implements IEventHandler {
    ...
    public void handleEvent(Event event) {
        try {
            ...
            throw new RuntimeException("Error processing background image: " + e.getMessage(), e);
        }
    }

    private void drawBackground(PdfDocument pdf, PdfPage page) throws IOException {
